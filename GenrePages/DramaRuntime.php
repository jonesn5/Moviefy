...
<nav class="navbar navbar-expand-md bg-light navbar-light">
  ...
  <p class="center" style="font-size:60px"> Drama </p>	
	<div align="center">
	   <h1 font-size="40px"> Sort by: </h1>
       		  <form action="DramaRating.php">
    			<input type="submit" value="Rating" />
		 </form>

      		 <form action="DramaRuntime.php">
    			<input type="submit" value="Runtime" />
		 </form>

     		    <form action="DramaYear.php">
    			<input type="submit" value="Year" />
		 </form>
	</div>

<?php
  $query = "SELECT * FROM movies WHERE genre='Drama' ORDER BY Runtime DESC";
