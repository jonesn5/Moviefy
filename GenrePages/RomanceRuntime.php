...
<nav class="navbar navbar-expand-md bg-light navbar-light">
  ...
  <p class="center" style="font-size:60px"> Romance </p>	
	<div align="center">
	   <h1 font-size="40px"> Sort by: </h1>
       		  <form action="RomanceRating.php">
    			<input type="submit" value="Rating" />
		 </form>

      		 <form action="RomanceRuntime.php">
    			<input type="submit" value="Runtime" />
		 </form>

     		    <form action="RomanceYear.php">
    			<input type="submit" value="Year" />
		 </form>
	</div>

<?php
  $query = "SELECT * FROM movies WHERE genre='Romance' ORDER BY Runtime DESC";
