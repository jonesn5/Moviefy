...
<nav class="navbar navbar-expand-md bg-light navbar-light">
  ...
  <p class="center" style="font-size:60px"> Children </p>	
	<div align="center">
	   <h1 font-size="40px"> Sort by: </h1>
       		  <form action="ChildrenRating.php">
    			<input type="submit" value="Rating" />
		 </form>

      		 <form action="ChildrenRuntime.php">
    			<input type="submit" value="Runtime" />
		 </form>

     		    <form action="ChildrenYear.php">
    			<input type="submit" value="Year" />
		 </form>
	</div>

<?php
  $query = "SELECT * FROM movies WHERE genre='Children' ORDER BY Runtime DESC";
