...
<nav class="navbar navbar-expand-md bg-light navbar-light">
  ...
  <p class="center" style="font-size:60px"> Action </p>	
	<div align="center">
	   <h1 font-size="40px"> Sort by: </h1>
       		  <form action="ActionRating.php">
    			<input type="submit" value="Rating" />
		 </form>

      		 <form action="ActionRuntime.php">
    			<input type="submit" value="Runtime" />
		 </form>

     		    <form action="ActionYear.php">
    			<input type="submit" value="Year" />
		 </form>
	</div>

<?php
  $query = "SELECT * FROM movies WHERE genre='Action' ORDER BY Runtime DESC";
