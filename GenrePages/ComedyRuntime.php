...
<nav class="navbar navbar-expand-md bg-light navbar-light">
  ...
  <p class="center" style="font-size:60px"> Comedy </p>	
	<div align="center">
	   <h1 font-size="40px"> Sort by: </h1>
       		  <form action="ComedyRating.php">
    			<input type="submit" value="Rating" />
		 </form>

      		 <form action="ComedyRuntime.php">
    			<input type="submit" value="Runtime" />
		 </form>

     		    <form action="ComedyYear.php">
    			<input type="submit" value="Year" />
		 </form>
	</div>

<?php
  $query = "SELECT * FROM movies WHERE genre='Comedy' ORDER BY Runtime DESC";
