...
<nav class="navbar navbar-expand-md bg-light navbar-light">
  ...
  <p class="center" style="font-size:60px"> Sci-Fi </p>	
	<div align="center">
	   <h1 font-size="40px"> Sort by: </h1>
       		  <form action="Sci-FiRating.php">
    			<input type="submit" value="Rating" />
		 </form>

      		 <form action="Sci-FiRuntime.php">
    			<input type="submit" value="Runtime" />
		 </form>

     		    <form action="Sci-FiYear.php">
    			<input type="submit" value="Year" />
		 </form>
	</div>

<?php
  $query = "SELECT * FROM movies WHERE genre='Sci-Fi' ORDER BY Runtime DESC";
