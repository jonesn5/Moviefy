...
<nav class="navbar navbar-expand-md bg-light navbar-light">
  ...
  <p class="center" style="font-size:60px"> Horror </p>	
	<div align="center">
	   <h1 font-size="40px"> Sort by: </h1>
       		  <form action="HorrorRating.php">
    			<input type="submit" value="Rating" />
		 </form>

      		 <form action="HorrorRuntime.php">
    			<input type="submit" value="Runtime" />
		 </form>

     		    <form action="HorrorYear.php">
...
<?php
  ...
  $result = $db->query($query);
	...
	while($row = mysqli_fetch_array($result)) {
		...
		<img src="./Images/<?php echo $row['image'] ?>" style="width:250px;height:350px;" float: left; margin: 10px 10px 10px 0;/>
			<div display: inline;>
			<?php echo "<p>" . $row['description'] . "</p><br>" . $row['director'] . " " . $row['Runtime'] . " min Release Year: " . $row['year'] . " " . $row['rating'] . "/5 Stars<br>";
