...
<body>
  ...
  <div class="ratingSystem">
    ...
    if (isset($_POST['rating'])) {
      $sql = "SELECT AVG(rating) FROM ratings WHERE pageID = 'palmsprings-2020';";
      $result = $db->query($sql);
   ...
   <form class="form-inline" method="post" action="palmsprings-2020.php">
    <input type="hidden" name="pageID" value="palmsprings-2020">
      ...
      <div class="col-md-8">
        ...
        <div>
          ...
          function getComments() {
            ...
            $sql = "SELECT * FROM comments WHERE pageID = 'palmsprings-2020';";
                    ...
                    <div class="card-body">
                      ...
                      if(isAdmin()){
                        ...
                        if (isset($_POST['delete'])) {
                          $sql = "DELETE FROM comments WHERE pageID = 'palmsprings-2020' AND comment = '" . $_POST['pageID'] . "'";
                          $result = $db->query($sql);
