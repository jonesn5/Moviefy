...
<body>
  ...
  <div class="container mt-5 bg-light">
    <div class="row d-flex justify-content-center">
      <div class="col-lg-6">
        ...
        <p>A Manhattan artist relocates her young family to a historic hamlet in the Hudson Valley. As she settles into a new life, she begins to suspect that her marriage has a sinister darkness, one that rivals her new home's history. Based on the acclaimed novel by Elizabeth Brundange. ("Things Heard & Seen")<br>Genre: Drama</p>
      </div>
      <div class="col-lg-1">
      </div>
      <div class="col-lg-4">
        <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&amp;bg=55595c&amp;fg=eceeef&amp;text=Thumbnail" alt="Things Heard and Seen movie poster" src="https://m.media-amazon.com/images/M/MV5BYjRjYzAxYjAtMTQ0NC00YmJkLTk3MTctNDQ5OTQ4NWM4ZGEwXkEyXkFqcGdeQXVyMjM4NTM5NDY@._V1_.jpg" data-holder-rendered="true" style="height: 420px; width: 100%; display: block;">
      </div>
    </div>
  </div>
  ...
  <div class="ratingSystem">
    ...
    if (isset($_POST['rating'])) {
      $sql = "SELECT AVG(rating) FROM ratings WHERE pageID = 'thingsheardandseen-2021';";
      $result = $db->query($sql);
   ...
   <form class="form-inline" method="post" action="thingsheardandseen-2021.php">
    <input type="hidden" name="pageID" value="thingsheardandseen-2021">
      ...
      <div class="col-md-8">
        ...
        <div>
          ...
          function getComments() {
            ...
            $sql = "SELECT * FROM comments WHERE pageID = 'thingsheardandseen-2021';";
                    ...
                    <div class="card-body">
                      ...
                      if(isAdmin()){
                        ...
                        if (isset($_POST['delete'])) {
                          $sql = "DELETE FROM comments WHERE pageID = 'thingsheardandseen-2021' AND comment = '" . $_POST['pageID'] . "'";
                          $result = $db->query($sql);
