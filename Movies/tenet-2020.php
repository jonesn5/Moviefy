...
<body>
  ...
  <div class="container mt-5 bg-light">
    <div class="row d-flex justify-content-center">
      <div class="col-lg-6">
        ...
        <p>Armed with only one word—Tenet—and fighting for the survival of the entire world, the Protagonist journeys through a twilight world of international espionage on a mission that will unfold in something beyond real time. Not time travel. Inversion.<em> (Action)</em></p>
      </div>
      <div class="col-lg-1">
      </div>
      <div class="col-lg-4">
        <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&amp;bg=55595c&amp;fg=eceeef&amp;text=Thumbnail" alt="Tenet movie poster" src="https://m.media-amazon.com/images/M/MV5BYzg0NGM2NjAtNmIxOC00MDJmLTg5ZmYtYzM0MTE4NWE2NzlhXkEyXkFqcGdeQXVyMTA4NjE0NjEy._V1_.jpg" data-holder-rendered="true" style="height: 420px; width: 100%; display: block;">
      </div>
    </div>
  </div>
  ...
  <div class="ratingSystem">
    ...
    if (isset($_POST['rating'])) {
      $sql = "SELECT AVG(rating) FROM ratings WHERE pageID = 'tenet-2020';";
      $result = $db->query($sql);
   ...
   <form class="form-inline" method="post" action="tenet-2020.php">
    <input type="hidden" name="pageID" value="tenet-2020">
      ...
      <div class="col-md-8">
        ...
        <div>
          ...
          function getComments() {
            ...
            $sql = "SELECT * FROM comments WHERE pageID = 'tenet-2020';";
                    ...
                    <div class="card-body">
                      ...
                      if(isAdmin()){
                        ...
                        if (isset($_POST['delete'])) {
                          $sql = "DELETE FROM comments WHERE pageID = 'tenet-2020' AND comment = '" . $_POST['pageID'] . "'";
                          $result = $db->query($sql);
