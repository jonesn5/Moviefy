  ...
  <div class="container mt-5 bg-light">
    ...
    <div class="ratingSystem">
      ...
      if (isset($_POST['rating'])) {
        $sql = "SELECT AVG(rating) FROM ratings WHERE pageID = 'stowaway-2021';";
        $result = $db->query($sql);
     ...
     <form class="form-inline" method="post" action="stowaway-2021.php">
        ...
        <div class="col-md-8">
          <div class="headings d-flex justify-content-between align-items-center mb-3">
            <form class="form-inline" method="post" action="stowaway-2021.php">
              ...
              <input type="hidden" name="pageID" value="stowaway-2021">
          ...
          <div>
            ...
            function getComments() {
              ...
              $sql = "SELECT * FROM comments WHERE pageID = 'stowaway-2021';";
