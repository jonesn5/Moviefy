...
<body>
  ...
  <div class="container mt-5 bg-light">
    <div class="row d-flex justify-content-center">
      <div class="col-lg-6">
        ...
        <p>Scooby-Doo is the hero of his own story in "SCOOB!," the first full-length animated Scooby-Doo adventure, which reveals how he and his best friend Shaggy became two of the world's most beloved crime busters. The story takes us back to where it all began when a young Scooby and Shaggy first meet and team up with Velma, Daphne, and Fred to launch Mystery Incorporated. ("Scoob!")<br>Genre: Family</em></p>
      </div>
      <div class="col-lg-1">
      </div>
      <div class="col-lg-4">
        <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&amp;bg=55595c&amp;fg=eceeef&amp;text=Thumbnail" alt="Scoob movie poster" src="https://m.media-amazon.com/images/M/MV5BMDM4N2EzMjQtZTNkOS00YjlkLWI1ZGEtMTBhYzg5YWNkMmJjXkEyXkFqcGdeQXVyMTA4NjE0NjEy._V1_.jpg" data-holder-rendered="true" style="height: 420px; width: 100%; display: block;">
      </div>
    </div>
  </div>
  ...
  <div class="ratingSystem">
    ...
    if (isset($_POST['rating'])) {
      $sql = "SELECT AVG(rating) FROM ratings WHERE pageID = 'scoob-2020';";
      $result = $db->query($sql);
   ...
   <form class="form-inline" method="post" action="scoob-2020.php">
    <input type="hidden" name="pageID" value="scoob-2020">
      ...
      <div class="col-md-8">
        ...
        <div>
          ...
          function getComments() {
            ...
            $sql = "SELECT * FROM comments WHERE pageID = 'scoob-2020';";
                    ...
                    <div class="card-body">
                      ...
                      if(isAdmin()){
                        ...
                        if (isset($_POST['delete'])) {
                          $sql = "DELETE FROM comments WHERE pageID = 'scoob-2020' AND comment = '" . $_POST['pageID'] . "'";
                          $result = $db->query($sql);
