    ...
    <div class="container mt-5 bg-light">
        ...
        <div class="ratingSystem">
            ...
            if (isset($_POST['rating'])) {
                $sql = "SELECT AVG(rating) FROM ratings WHERE pageID = 'us-2019';";
                $result = $db->query($sql);
                    ...
                    <div class="card-body">
                      ...
                      if(isAdmin()){
                        ...
                        if (isset($_POST['delete'])) {
                          $sql = "DELETE FROM comments WHERE pageID = 'us-2019' AND comment = '" . $_POST['pageID'] . "'";
                          $result = $db->query($sql);
