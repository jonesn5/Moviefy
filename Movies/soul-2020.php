...
<body>
  ...
  <div class="container mt-5 bg-light">
    <div class="row d-flex justify-content-center">
      <div class="col-lg-6">
        ...
        <p>Joe is a middle-school band teacher whose life hasn't quite gone the way he expected. His true passion is jazz -- and he's good. But when he travels to another realm to help someone find their passion, he soon discovers what it means to have soul. ("Soul")<br>Genre: Family</p>
      </div>
      <div class="col-lg-1">
      </div>
      <div class="col-lg-4">
        <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&amp;bg=55595c&amp;fg=eceeef&amp;text=Thumbnail" alt="Soul movie poster" src="https://i.ytimg.com/vi/EVB21AxR1Hw/movieposter.jpg" data-holder-rendered="true" style="height: 420px; width: 100%; display: block;">
      </div>
    </div>
  </div>
  ...
  <div class="ratingSystem">
    ...
    if (isset($_POST['rating'])) {
      $sql = "SELECT AVG(rating) FROM ratings WHERE pageID = 'soul-2020';";
      $result = $db->query($sql);
   ...
   <form class="form-inline" method="post" action="soul-2020.php">
    <input type="hidden" name="pageID" value="soul-2020">
      ...
      <div class="col-md-8">
        ...
        <div>
          ...
          function getComments() {
            ...
            $sql = "SELECT * FROM comments WHERE pageID = 'soul-2020';";
                    ...
                    <div class="card-body">
                      ...
                      if(isAdmin()){
                        ...
                        if (isset($_POST['delete'])) {
                          $sql = "DELETE FROM comments WHERE pageID = 'soul-2020' AND comment = '" . $_POST['pageID'] . "'";
                          $result = $db->query($sql);
